...
do
   echo "$i"
   query='{"_source":false,"suggest":{"name-suggest":{"completion":{"contexts":{"store_and_status":["published"]},"field":"suggest_2","fuzzy":true,"size":101,"skip_duplicates":true},"prefix":"'$i'"}}}'
